...
@section('content')
<div class="container mx-auto px-4 p-10 bg-gray-100 rounded-xl shadow-2xl max-w-2xl">
    ...
    <div class="bg-white p-8 rounded-xl shadow-2xl">
        ...
        <form method="POST" action="{{ route('admin.exams.store') }}">
            ...
            <div class="flex justify-end space-x-4">
                <button type="submit"
                        class="bg-green-600 text-white px-6 py-2 rounded-lg hover:bg-green-700 focus:ring-2 focus:ring-green-500 transition duration-200">
                    Create Exam
                </button>
